...
createWrapperForServiceFunction = function (serviceFunction, methodName) {
	return function (params, callback) {
		try {
			serviceFunction(params, function (err) {
				if (err) {
					// convert JS error object to a more readable version
					return callback({
						code:500,
			...
			log.error("ERROR occured during call to method:", methodName, e, e.stack);
			if (e &&
				e.code &&
				e.message) {
				callback(e);
